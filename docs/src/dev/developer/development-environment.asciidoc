...
The build optionally requires link:https://go.dev/dl/[Go] (>=1.7) to work with the `gremlin-go` module. If Go is not installed, TinkerPop will still build with Maven, but Go projects will be skipped.
