...
Note: Currently as of Milestone #2, Gremlin-Go exists in the `lyndonb-bq` fork on the `gremlin-go-ms5` branch. Expect this to change in the future when the project is closer to a completed state.
